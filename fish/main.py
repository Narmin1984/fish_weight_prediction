...
# Add a text or label field to display the value or action
st.text("Value or Action: " + str("deployment"))
...
input_Length1 = st.selectbox('Vertical length(cm)', 0.0, max(data["Length1"]), 1.0)
